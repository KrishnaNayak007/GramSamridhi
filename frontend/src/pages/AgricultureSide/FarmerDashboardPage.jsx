...
export default function FarmerDashboardPage({ onNavigate }) {
  ...
  const handleCompostRequestSubmit = (e) => {
    ...
    triggerToast(
      `Compost request for ${compostRequestQty} kg submitted successfully!`,
    );
  };
  ...
  const handlePickupRequest = (e) => {
    ...
    triggerToast(
      `Residue pickup request for ${residueQty} kg of ${residueType} submitted!`,
    );
  };
    ...
    <div className="farmer-dashboard-container">
      ...
      <section className="hero-card" aria-label="Farm overview">
        ...
        <div className="hero-copy">
          <span className="eyebrow" style={{ color: "var(--palette-gold)" }}>
            CIRCULAR FARMING
          </span>
          <h2>
            Turn crop residue
            <br />
            <span>into a valuable resource.</span>
          </h2>
          <p>
            Avoid burning. Request collection, earn compost credits and improve
            your soil organic carbon.
          </p>
          <div className="hero-actions">
            <a
              className="primary-button"
              href="#requestPickupForm"
              onClick={(e) => {
                e.preventDefault();
                document
                  .getElementById("requestPickupForm")
            ...
            >
              ...
              <svg
                ...
                strokeWidth="2"
              >
                <path d="M4 19.5V6a2 2 0 0 1 2-2h13.5v14H7a2 2 0 0 0-2 2Z" />
                <path d="M6 17.5h13.5" />
                <path d="M8 8h9M8 11.2h9" />
              </svg>
            </a>
          </div>
        </div>
        ...
        <div className="pickup-panel">
          <div className="panel-label">
            ...
            <svg
              ...
              stroke="currentColor"
              strokeWidth="2"
              style={{ marginLeft: "auto", width: "15px", height: "15px" }}
            >
        ...
        <article>
          <span className="metric-icon green">
            <svg
              ...
              strokeWidth="2"
            >
              <path d="M5 19c-.6-6.8 3-13 13-14 1 9-4.8 13.5-13 14Z" />
              <path d="M6 18c2.3-2.6 4.6-5 8.7-8.4" />
            </svg>
          </span>
          <div>
        ...
        <article>
          <span className="metric-icon brown">
            <svg
              ...
              strokeWidth="2"
            >
              <path d="M12 21c4-3 6-6.2 6-9.6C18 7.6 15.3 4 12 2 8.7 4 6 7.6 6 11.4 6 14.8 8 18 12 21Z" />
              <path d="M12 21v-7" />
            </svg>
          </span>
          <div>
      ...
      <section className="main-grid">
        ...
        <article className="card assistant-card" id="assistant">
          ...
          <div className="quick-prompts">
            <button
              type="button"
              onClick={() => handlePromptClick("मेरी मिट्टी के लिए कम्पोस्ट?")}
            >
              मेरी मिट्टी के लिए कम्पोस्ट?
            </button>
            <button
              type="button"
              onClick={() => handlePromptClick("धान का अवशेष कैसे संभालें?")}
            >
              धान का अवशेष कैसे संभालें?
            </button>
            <button
              type="button"
              onClick={() => handlePromptClick("When should I irrigate?")}
            >
              When should I irrigate?
            </button>
            <button
              type="button"
              onClick={() => handlePromptClick("Best green manure for paddy?")}
            >
              Best green manure for paddy?
            </button>
          </div>
          ...
          <small className="integration-note">
            Demo mode • Powered by GramSamridhii Agri AI Knowledge Base.
          </small>
        </article>
        ...
        <article className="card collection-card" id="residue">
          <div className="card-title-row">
            <div>
              ...
              <h2>Residue collection</h2>
            </div>
            <span className="status-pill">Scheduled</span>
          </div>
          <div className="request-summary">
            <b>Paddy straw &nbsp;·&nbsp; 650 kg</b>
            <small>Request #RC-4892</small>
          </div>
          <ol className="timeline">
            <li className="done">
              ...
              <div>
                ...
                <small>20 Aug 2026, 10:15 AM</small>
              </div>
            </li>
            <li className="done">
              <i>
              ...
              <div>
                <b>Collection partner assigned</b>
                <small>GreenEarth NGO · 21 Aug, 02:40 PM</small>
              </div>
            </li>
            <li className="current">
              ...
              <div>
                <b>Pickup scheduled</b>
                <small>Tomorrow, 09:00 – 11:00 AM</small>
              </div>
            </li>
            <li>
              <i></i>
              <div>
                <b>Material processed</b>
                <small>Compost credit will be issued</small>
              </div>
            </li>
          </ol>
        ...
        <article className="card request-card" id="requestPickupForm">
          <div className="card-title-row">
            <div>
              ...
              <h2>Turn residue into a resource</h2>
            </div>
          ...
          <p className="card-description">
            Schedule a crop residue pickup to earn compost credit instead of
            burning it.
          </p>
          <form className="collection-form" onSubmit={handlePickupRequest}>
            ...
            <small className="form-note">
              ⓘ Collection availability depends on local NGO networks.
            </small>
          </form>
        </article>
      </section>
      ...
      <section className="lower-grid">
        ...
        <article className="card standard-card" id="compost">
          ...
          <div className="progress-row">
            ...
            <b>{compostReceived} / 450 kg</b>
          </div>
          <div className="progress">
            <i
              style={{ width: `${Math.round((compostReceived / 450) * 100)}%` }}
            ></i>
          </div>
        </article>
        ...
        <article className="card standard-card impact-card" id="impact">
          ...
          <div className="impact-stats">
            <div>
              <span className="impact-icon">
                ...
                >
                  <path d="M7 3 4 8l3 5" />
                  <path d="M4 8h9.5A5.5 5.5 0 0 1 19 13.5V15" />
                  <path d="M17 21l3-5-3-5" />
                  <path d="M20 16h-9.5A5.5 5.5 0 0 1 5 10.5V9" />
                </svg>
              </span>
              <b>
                {(residueDiverted + (pickupScheduled - 650)).toLocaleString()}{" "}
                kg
              </b>
              <small>Residue diverted</small>
            </div>
            <div>
              <span className="impact-icon">
                <svg
                  ...
                  strokeWidth="2"
                >
                  <path d="M17.5 19A3.5 3.5 0 0 0 21 15.5c0-2.79-2.54-4.5-5-5-2.46.5-5 2.21-5 5A3.5 3.5 0 0 0 14.5 19h3z" />
                  <path d="M7.5 15A4.5 4.5 0 0 1 12 10.5c0-3.59-3.27-5.79-6.43-6.43A4.5 4.5 0 0 0 3 10.5 4.5 4.5 0 0 0 7.5 15z" />
                </svg>
              </span>
              <b>0.86 t</b>
          ...
          <div className="impact-chart" aria-label="Monthly residue diverted">
            ...
            <div className="impact-bars">
              <button
                className="impact-bar-wrap"
                type="button"
                aria-label="March: 180 kilograms"
              >
              ...
              <button
                className="impact-bar-wrap"
                type="button"
                aria-label="April: 260 kilograms"
              >
              ...
              <button
                className="impact-bar-wrap active"
                type="button"
                aria-label="August: 1240 kilograms"
              >
          ...
          <p className="impact-caption">
            <b>{residueDiverted.toLocaleString()} kg</b> of residue diverted
            from open burning this season.
          </p>
        ...
        <article className="card standard-card next-card">
          ...
          <div className="next-list">
            <button type="button">
              ...
              <span>
                <b>Prepare bio-enriched compost</b>
            ...
            <button type="button">
              <span className="next-icon">
                <svg
                  ...
                  strokeWidth="2"
                >
                  <path d="M3 18.5 8 7l4 6 3-4 6 9.5" />
                  <path d="M3 20.5h18" />
                </svg>
              </span>
              <span>
                <b>Improve soil organic carbon</b>
        ...
        <article className="scheme-card" id="schemes">
          <div className="scheme-topline">
            ...
            <span className="scheme-mark" aria-hidden="true">
              PK
            </span>
          </div>
          ...
          <p>
            Support for cluster-based organic farming, certifications, and
          ...
          <div className="scheme-footer">
            ...
            <button
              onClick={() =>
                triggerToast("Opening PKVY program registration links...")
              }
            >
              Explore PKVY
              <svg
      ...
      <section id="guidance" className="guidance-strip card">
        <div>
          ...
          <h2>Organic farming guidance</h2>
        </div>
        <div className="guidance-list">
          <button
            type="button"
            onClick={() =>
              triggerToast("Opening guide: Prepare bio-enriched compost")
            }
          >
            <svg
              viewBox="0 0 24 24"
            ...
            <span>
              <b>Prepare bio-enriched compost</b>
              <small>For paddy fields</small>
            </span>
          </button>
          <button
            type="button"
            onClick={() =>
              triggerToast("Opening guide: Natural pest management")
            }
          >
            <svg
              viewBox="0 0 24 24"
            ...
            <span>
              <b>Natural pest management</b>
              <small>Neem-based practices</small>
            </span>
          </button>
          <button
            type="button"
            onClick={() =>
              triggerToast("Opening guide: Improve soil organic carbon")
            }
          >
            <svg
              viewBox="0 0 24 24"
            ...
            <span>
              <b>Improve soil organic carbon</b>
              <small>Simple actions this season</small>
            </span>
          </button>
        </div>
        <a
      ...
      {!isModalOpen ? null : (
        <div className="modal-backdrop" onClick={() => setIsModalOpen(false)}>
          ...
          >
            ...
            <span class="eyebrow" style={{ color: "var(--palette-gold)" }}>
              COMPOST REQUEST
            </span>
            <h2 id="modalTitle">Use your compost credit</h2>
            <p>
              You have {compostCredit} kg available. Submit a request and the
              local NGO partner will coordinate doorstep delivery.
            </p>
            <label>
              Quantity needed (kg)
              <input
            ...
            <button
              className="primary-button"
              onClick={handleCompostRequestSubmit}
            >
              Submit request
              <svg
                viewBox="0 0 24 24"
