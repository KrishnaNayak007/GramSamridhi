...
export default function SettingsPage() {
  ...
  const [language, setLanguage] = useState(
    localStorage.getItem("swachhLanguage") || "English",
  );
  const [distanceUnit, setDistanceUnit] = useState(
    localStorage.getItem("swachhDistanceUnit") || "Kilometers (km)",
  );
  const [theme, setTheme] = useState(
    localStorage.getItem("swachhTheme") || "light",
  );
  const [fontSize, setFontSize] = useState(
    localStorage.getItem("swachhFontSize") || "medium",
  );
  ...
  const handleThemeChange = (selectedTheme) => {
    ...
    triggerToast(
      selectedTheme === "dark" ? "Dark mode enabled" : "Light mode enabled",
    );
  };
  ...
  return (
    <div className="settings-page">
      ...
      <section className="hero">
        ...
        <p>
          Manage your account, preferences, privacy and security — all in one
          place.
        </p>
        ...
        <section className="card">
          ...
          <div className="preference-grid">
            ...
            <div className="preference">
              ...
              <div className="preference-desc">
                Used for nearby complaints &amp; listings
              </div>
        ...
        <section className="card">
          ...
          <div className="setting-row">
            <div>
              ...
              <span className="setting-desc">
                Get updates on your complaint status
              </span>
            </div>
            <button
              type="button"
              ...
              onClick={() =>
                handleToggleSwitch("SWC Updates", swcUpdates, setSwcUpdates)
              }
          ...
          <div className="setting-row">
            <div>
              ...
              <span className="setting-desc">
                Get updates on listings and requests
              </span>
            </div>
            <button
              type="button"
          ...
          <div className="setting-row">
            <div>
              ...
              <span className="setting-desc">
                Receive messages and chat notifications
              </span>
            </div>
            <button
              type="button"
          ...
          <div className="setting-row">
            <div>
              ...
              <span className="setting-desc">
                Get notified about your impact and badges
              </span>
            </div>
            <button
              type="button"
        ...
        <section className="card">
          ...
          <div className="privacy-row">
            ...
            <select
              ...
              onChange={(e) =>
                handlePrivacySelectChange("profile_visibility", e.target.value)
              }
            >
          ...
          <div className="privacy-row">
            ...
            <select
              ...
              onChange={(e) =>
                handlePrivacySelectChange("contact_visibility", e.target.value)
              }
            >
          ...
          <div className="privacy-row">
            <div>
              ...
              <span className="setting-desc">
                Share precise location with authorities
              </span>
            </div>
            <select
              className="privacy-select"
              ...
              onChange={(e) =>
                handlePrivacySelectChange("location_sharing", e.target.value)
              }
            >
          ...
          <div className="app-grid">
            <div className="app-item">
              ...
              <button
                ...
                onClick={() =>
                  handleToggleSwitch("Data Saver", dataSaver, setDataSaver)
                }
