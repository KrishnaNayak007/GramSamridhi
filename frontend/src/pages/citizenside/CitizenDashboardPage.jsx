...
export default function CitizenDashboardPage({ onNavigate }) {
  ...
  return (
    <div className="citizen-dashboard-container">
      ...
      <div className="section-head" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '22px 0 12px' }}>
