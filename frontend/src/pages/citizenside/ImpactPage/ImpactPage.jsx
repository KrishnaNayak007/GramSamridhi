...
export default function ImpactPage() {
  ...
  useEffect(() => {
    // 1. Activate entry animations
    setRevealVisible(true);

    // 2. Count-up animation loop
    const duration = 900;
    ...
    const step = (timestamp) => {
      ...
      setWasteCount(eased * 2400);
      setComplaintsCount(eased * 156);
      setResidueCount(eased * 860);
      setPaymentsCount(eased * 184000);
      setVillagesCount(eased * 18);
