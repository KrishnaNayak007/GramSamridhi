...
export default function SwcPage({ onNavigate }) {
  ...
  const confirmSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        const data = await response.json();
        setTicketId(data.id || 'SWC-2026-' + Math.floor(10000 + Math.random() * 89999));
  ...
  return (
    <div className="wrap">
      ...
      {/* Breadcrumb */}
      <div className="crumb">
        <span style={{ cursor: 'pointer', color: 'var(--green)' }} onClick={() => onNavigate('dashboard')}>Home</span>
      ...
      <div className="hero-banner">
        ...
        <div className="swc-hero-copy">
          ...
          <h1 className="hero-title">See it. Report it.<br /><span>We’ll clean it.</span></h1>
          <p className="hero-sub">Spot a waste issue? Capture it, add your location, and let SWC use smart detection to route the complaint to the right sanitation team — faster.</p>
          <div className="hero-ctas">
            <button className="hero-primary" type="button" onClick={() => {
            ...
            <button className="hero-secondary" type="button" onClick={() => showToast('Map view is ready for your complaint location')}>
          ...
          <div className="hero-tags">
            <span className="hero-tag">
              <svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m13 2-9 12h7l-1 8 9-12h-7l1-8Z" /></svg>
              Quick Report
            </span>
            <span className="hero-tag">
            ...
            <span className="hero-tag">
              <svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 5 20 3c0 4-2 5-3 10a7 7 0 0 1-6 7Z" /></svg>
              AI Powered
            </span>
          </div>
        </div>
        <div className="hero-visual" aria-label="SWC smart waste visual">
          <img src={swcHero} alt="Smart Waste Complaint recycling bins in a clean city" />
          <div className="hero-visual-badge"><span className="pulse"></span> SWC AI Vision Ready</div>
        </div>
        <button className="btn-ghost hero-help" onClick={() => showToast('Capture image -> AI classifies type -> Automatically routes to assigned Officer')}>
      ...
      <div className="card stepper-card">
        <div className="stepper" id="stepper">
          <div className={`step ${step > 1 ? 'complete' : ''} ${step === 1 ? 'active' : ''}`} data-step="1">
            <div className="step-line"></div>
            <div className="step-num">01</div>
            <div className="step-text"><div class="step-label">Upload Photo</div><div class="step-desc">Capture or upload waste image</div></div>
          </div>
          <div className={`step ${step > 2 ? 'complete' : ''} ${step === 2 ? 'active' : ''}`} data-step="2">
            <div className="step-line"></div>
            <div className="step-num">02</div>
            <div className="step-text"><div class="step-label">AI Detection</div><div class="step-desc">AI analyzes the waste</div></div>
          </div>
          <div className={`step ${step > 3 ? 'complete' : ''} ${step === 3 ? 'active' : ''}`} data-step="3">
            <div className="step-line"></div>
            <div className="step-num">03</div>
            <div className="step-text"><div class="step-label">Add Details</div><div class="step-desc">Provide location &amp; description</div></div>
          </div>
          <div className={`step ${step === 4 ? 'active' : ''}`} data-step="4">
            <div className="step-num">04</div>
            <div className="step-text"><div class="step-label">Submit</div><div class="step-desc">Routed to the right authority</div></div>
          </div>
        </div>
      </div>
      ...
      <div className="main-grid">
                  ...
                  {!previewSrc ? (
                    <div id="dz-empty">
                      ...
                      <div className="dz-actions">
                        <button className="btn-solid" type="button" onClick={(e) => { e.stopPropagation(); fileInputRef.current?.click(); }}>
                        ...
                        <button className="btn-outline" type="button" onClick={(e) => { e.stopPropagation(); fileInputRef.current?.click(); }}>
                    ...
                    <div id="dz-preview" className="img-preview-wrap">
                      ...
                      <button className="img-close" type="button" onClick={(e) => { e.stopPropagation(); removePhoto(); }} aria-label="Remove photo">
          ...
          <div className="card">
            ...
            <form onSubmit={handleSubmit}>
              <div className="two-col">
                <div className="field">
                  <label>Waste Type <span className="req">*</span></label>
                  <select 
                    value={wasteType} 
                ...
                <div className="field">
                  ...
                  <div className="loc-input-row">
                    <input 
                      ...
                      required
                    />
                    <button className="loc-btn" type="button" onClick={triggerGPS} aria-label="Use current location">
              ...
              <div className="field">
                ...
                <textarea 
                  ...
                  required
                />
                <div className="char-count"><span>{description.length}</span>/300</div>
              </div>

              <div className="submit-row">
                <button className="btn-outline" style={{ flex: 0, padding: '13px 20px' }} type="button" onClick={handleReset}>Reset</button>
                <button className="btn-solid" type="submit" disabled={!analyzed}>
                  Submit Complaint
        ...
        <div className="col-right">
          ...
          <div className="card" id="aiCard">
            ...
            <p className="card-sub" style={{ marginBottom: '14px' }}>AI checks the photo and prepares a faster, smarter complaint.</p>
            ...
            {isAnalyzing && (
              <div id="aiScanning">
                ...
                <div className="scan-steps">
                  <div className={`scan-step ${scanStepIndex >= 0 ? 'on' : ''}`}>
                  ...
                  <div className={`scan-step ${scanStepIndex >= 1 ? 'on' : ''}`}>
                    <span className="sicon">
                      {scanStepIndex > 1 ? (
                        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                      ) : scanStepIndex === 1 ? (
                  ...
                  <div className={`scan-step ${scanStepIndex >= 2 ? 'on' : ''}`}>
                    <span className="sicon">
                      {scanStepIndex > 2 ? (
                        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                      ) : scanStepIndex === 2 ? (
                  ...
                  <div className={`scan-step ${scanStepIndex >= 3 ? 'on' : ''}`}>
                    <span className="sicon">
                      {scanStepIndex > 3 ? (
                        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                      ) : scanStepIndex === 3 ? (
            ...
            {analyzed && (
              <div className="ai-result" style={{ display: 'block' }}>
                <div className="result-top">
                  <img className="result-thumb" src={previewSrc} alt="Result thumbnail" />
                  <div className="result-meta">
                    <div className="meta-row"><span className="meta-label">Waste Type</span><span className="meta-val">{wasteType || 'Garbage Accumulation'}</span></div>
                    <div className="meta-row"><span className="meta-label">Category</span><span className="meta-val">Mixed Waste</span></div>
                    <div className="meta-row"><span className="meta-label">Severity</span><span className="pill pill-high">High</span></div>
                  </div>
                </div>
                <div className="confidence-row">
                  ...
                  <div className="conf-text"><b>AI Confidence Score</b><small>High confidence detection based on visual patterns</small></div>
                </div>
                <div className="chips">
                  <div className="chip"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 8h14l-1 12H6L5 8Z" /><path d="M9 8V6a3 3 0 0 1 6 0v2" /></svg>Plastic</div>
                  <div className="chip"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v6M8 8h8l1 13H7L8 8Z" /></svg>Food Waste</div>
                  <div className="chip"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 3h9l3 3v15H6V3Z" /><path d="M9 12h6M9 16h6" /></svg>Paper</div>
                  <div className="chip"><svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9" /><path d="M8 12h8" /></svg>Other</div>
                </div>
          ...
          <div className={`card ${!analyzed ? 'locked' : ''}`} id="routingCard">
            <div className="locked-inner">
              <div className="row-between">
                ...
                <span className="btn-ghost" style={{ padding: '6px 12px', fontSize: '12px', cursor: 'pointer' }} onClick={() => showToast('Editing coordinates via map is enabled')}>Change Location</span>
              </div>
              ...
              <div className="routing-block">
                ...
                <div className="rb-val">Park Road, Sector 5<br />Ward 24, XYZ Nagar Nigam</div>
              </div>
              ...
              <div className="smart-routing-card" style={{ borderRadius: 'var(--r-sm)', padding: '14px' }}>
                ...
                <p>Based on the detected location and waste category, your complaint will be routed to the responsible municipal department.</p>
              </div>
            </div>
            {!analyzed && (
          ...
          <div className="card">
            <div className="row-between" style={{ marginBottom: '10px' }}>
              <div className="card-title" style={{ marginBottom: 0 }}>Recent Complaints Nearby</div>
              <span style={{ fontSize: '12px', fontWeight: 700, color: 'var(--green)', cursor: 'pointer' }} onClick={() => onNavigate('activity')}>View All</span>
            </div>
            
            <div className="complaint-item">
              <div className="complaint-thumb-wrap">
                <img src="https://images.unsplash.com/photo-1618477388954-7852f32655ec?w=120&h=120&fit=crop" alt="Garbage accumulation" />
              </div>
              <div className="complaint-body">
                <b>Garbage Accumulation</b>
                <div className="loc">
                  <svg viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /></svg>
                  Park Road, Sector 5
                </div>
            ...
            <div className="complaint-item">
              <div className="complaint-thumb-wrap">
                <img src="https://images.unsplash.com/photo-1604187351574-c75ca79f5807?w=120&h=120&fit=crop" alt="Overflowing bin" />
              </div>
              <div className="complaint-body">
                <b>Overflowing Bin</b>
                <div className="loc">
            ...
            <div className="complaint-item">
              <div className="complaint-thumb-wrap">
                <img src="https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?w=120&h=120&fit=crop" alt="Construction waste" />
              </div>
              <div className="complaint-body">
      ...
      <div className="impact-strip">
        <div className="impact-item">
          <div className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18" /><path d="M8 6V4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2" /><path d="M19 6l-1 14a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1L5 6" /></svg></div>
          <div><b>Report</b><span>Report waste issues in your area</span></div>
        </div>
        <div className="impact-item">
          <div className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="3" /><circle cx="8.5" cy="8.5" r="1.5" /><path d="m21 15-5-5L5 21" /></svg></div>
          <div><b>AI Detect</b><span>Automatically categorize the waste</span></div>
        </div>
        <div className="impact-item">
          <div className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12a9 9 0 1 1-2.6-6.3M21 3v6h-6" /></svg></div>
          <div><b>Smart Route</b><span>Send it to the right authority</span></div>
        </div>
        <div className="impact-item">
          <div className="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2 3 7v6c0 5 4 8 9 9 5-1 9-4 9-9V7l-9-5Z" /><path d="m9 12 2 2 4-4" /></svg></div>
          <div><b>Resolve</b><span>Build a cleaner, greener city</span></div>
        </div>
      </div>
      ...
      {showConfirmModal && (
        <div className="modal-bg show">
          <div className="modal-card">
            ...
            <div className="summary-row"><span>Severity</span><span>High</span></div>
      ...
      {showSuccessModal && (
        <div className="modal-bg show">
          <div className="modal-card center">
            ...
            <p className="sub">Your complaint has been routed to the Sanitation Department.</p>
